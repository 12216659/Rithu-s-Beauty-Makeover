  ...
  return (
    <div className="min-h-screen bg-transparent py-24 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-serif text-gray-900 mb-4">About <span className="text-brandBlack">Rithus Beauty Hub</span></h1>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
          ...
          <motion.div {...fadeInUp}>
            <h4 className="text-brandBlack tracking-widest uppercase text-sm font-bold mb-2">Our Story</h4>
        ...
        <motion.div 
          {...fadeInUp}
          className="bg-brandSilver rounded-3xl p-12 text-center"
        >
          <h3 className="text-3xl font-serif text-brandBlack mb-4">Ready to Shine Brighter?</h3>
